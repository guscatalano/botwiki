...
export const TYPES = {
  ...
  svg: { mime: 'image/svg+xml', inline: false, sandbox: true },
  ...
  mp4: { mime: 'video/mp4', inline: false, magicAt4: 'ftyp' },
  webm: { mime: 'video/webm', inline: false, magic: [0x1a, 0x45, 0xdf, 0xa3] },
  mp3: { mime: 'audio/mpeg', inline: false },
  wav: { mime: 'audio/wav', inline: false, magic: [0x52, 0x49, 0x46, 0x46] },
};
